...
from aki.tools.file_management.base_tools import WriteFileTool
...
class ShellCommandInput(BaseModel):
    ...
    working_dir: Optional[str] = Field(default=".", description="Working directory for command execution")


class ShellCommandTool(BaseTool, WriteFileTool):
